...
class FCViewController: UIViewController, UINavigationControllerDelegate {
    ...
    func configureDatabase() {
        ...
        // FIRDatabase renamed to Database
        ref = Database.database().reference()
        _refHandle = ref.child("messages").observe(.childAdded) {
            (snapshot:DataSnapshot) in self.messages.append(snapshot)
    ...
    deinit {
        // deinitialize when view is no longer being used
    ...
    func sendMessage(data: [String:String]) {
        ...
        // push message to the firebase database
...
extension FCViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // unpack data from firebase datasnapshot
